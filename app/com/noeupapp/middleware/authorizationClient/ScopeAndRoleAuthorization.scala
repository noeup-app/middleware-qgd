...
trait ScopeAndRoleAuthorization {
  def apply(scopeRoleAuthorization: WithScopeAuthorization,
            roleAuthorization: WithRoleAuthorization): Authorization[Account, CookieBearerTokenAuthenticator]
}
...
class FakeScopeAndRoleAuthorization @Inject() () extends ScopeAndRoleAuthorization {
  ...
  override def apply(scopeRoleAuthorization: WithScopeAuthorization,
            roleAuthorization: WithRoleAuthorization): Authorization[Account, CookieBearerTokenAuthenticator] = {
    new Authorization[Account, CookieBearerTokenAuthenticator] {
      override def isAuthorized[B](identity: Account,
                                   authenticator: CookieBearerTokenAuthenticator)
...
case class ScopeAndRoleAuthorizationService(
  ...
  extends Authorization[Account, CookieBearerTokenAuthenticator] {
  ...
  /**
    ...
    */
  override def isAuthorized[B](identity: Account, authenticator: CookieBearerTokenAuthenticator)(implicit request: Request[B], messages: Messages): Future[Boolean] = {
//    for{
...
object RoleAuthorization {
  ...
  trait WithRoleAuthorization extends Authorization[Account, CookieBearerTokenAuthenticator]
  ...
  case class WithRole(anyOf: String*) extends WithRoleAuthorization {
    def isAuthorized[A](account: Account, authenticator: CookieBearerTokenAuthenticator)(implicit r: Request[A], m: Messages) = Future.successful {
...
object ScopeAuthorization {
  ...
  trait WithScopeAuthorization extends Authorization[Account, CookieBearerTokenAuthenticator]
