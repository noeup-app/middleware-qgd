...
import com.noeupapp.middleware.notifications.notifiers.{RedisStorageNotificationActor, WebSocketNotificationActor}
...
/**
  ...
  */
class OnStart @Inject()(notification: Notification, pool: Pool) {
